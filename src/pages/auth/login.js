  ...
  return (
    <>
      <Head>
        ...
        {/* Primary Meta Tags */}
        <title>Login | AutoAb Database</title>
        <meta name="robots" content="noindex, nofollow" />
        <meta name="description" content="Sign in to access the AutoAb Database platform." />
      </Head>
      <div className="min-h-screen bg-gradient-to-br from-[#51d0de]/30 via-[#d9d9d9] to-[#bf4aa8]/30">
        ...
        <div className="flex flex-col items-center justify-center p-4 py-12">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center mb-8">
            ...
            <p className="text-slate-600 text-sm">{siteDescription}</p>
          </motion.div>

        {/* Login Card */}
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="bg-white rounded-2xl p-8 space-y-6 shadow-lg">
