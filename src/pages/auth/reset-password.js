    ...
    return (
      <>
        <Head>
          ...
          <title>Reset Password | AutoAb Database</title>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="flex flex-col items-center justify-center p-4 py-12">
            ...
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold text-white mb-2">CHANRE VEENA</h1>
              <p className="text-gray-300 text-sm">Rheumatology & Immunology Center</p>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 text-center">
            ...
            <div className="space-y-3">
              <Link
                ...
                className="block w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-2.5 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition-all duration-150 hover:scale-[1.02] text-center"
              >
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="bg-white rounded-2xl p-8 text-center">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-2.5 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition-all duration-150 hover:scale-[1.02]"
            >
              Continue to Login
            </button>
          </div>
        ...
        <div className="bg-white rounded-2xl p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-2.5 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition-all duration-150 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center space-x-2"
            >
