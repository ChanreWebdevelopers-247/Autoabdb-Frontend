  ...
  return (
    <>
      <Head>
        ...
        {/* Primary Meta Tags */}
        <title>404 - Page Not Found | AutoAb Database</title>
        ...
        <div className="text-center max-w-2xl mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            <div className="relative -mt-8">
              <div className="w-24 h-24 mx-auto bg-gradient-to-tr from-blue-600 to-blue-400 rounded-full flex items-center justify-center">
              ...
              {quickLinks.map((link) => {
                ...
                return (
                  <Link key={link.name} href={link.path}>
                    <span className="group flex flex-col items-center p-4 bg-white border-2 border-gray-100 rounded-xl hover:border-blue-200 transition-all cursor-pointer">
