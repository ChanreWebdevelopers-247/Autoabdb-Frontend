        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="bg-white/60 p-4 rounded-lg">
              <h4 className="text-slate-900 font-semibold mb-2">Service Providers</h4>
            ...
            <div className="bg-white/60 p-4 rounded-lg">
              <h4 className="text-slate-900 font-semibold mb-2">Legal Requirements</h4>
              <p className="text-slate-600 text-sm">
            ...
            <div className="bg-white/60 p-4 rounded-lg">
              <h4 className="text-slate-900 font-semibold mb-2">Business Transfers</h4>
              <p className="text-slate-600 text-sm">
            ...
            <div className="bg-white/60 p-4 rounded-lg">
              <h4 className="text-slate-900 font-semibold mb-2">Anonymized Data</h4>
              <p className="text-slate-600 text-sm">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="bg-white/60 p-4 rounded-lg">
              <h4 className="text-slate-900 font-semibold mb-2">Access and Correction</h4>
              <p className="text-slate-600 text-sm">
                You can access and update your account information at any time through your account settings.
              </p>
            </div>
            <div className="bg-white/60 p-4 rounded-lg">
              <h4 className="text-slate-900 font-semibold mb-2">Data Deletion</h4>
              <p className="text-slate-600 text-sm">
            ...
            <div className="bg-white/60 p-4 rounded-lg">
              <h4 className="text-slate-900 font-semibold mb-2">Opt-Out</h4>
              <p className="text-slate-600 text-sm">
            ...
            <div className="bg-white/60 p-4 rounded-lg">
              <h4 className="text-slate-900 font-semibold mb-2">Cookie Preferences</h4>
              <p className="text-slate-600 text-sm">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="bg-white/60 p-4 rounded-lg">
            <h4 className="text-slate-900 font-semibold mb-2">AutoAb Database Privacy Team</h4>
  ...
  return (
    <>
      ...
      <div className="relative z-10 px-4 sm:px-6 pt-8 sm:pt-16 pb-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-3 py-2 sm:px-4 mb-6 border border-slate-200/60">
              <Shield className="w-4 h-4 text-blue-600" />
              <span className="text-xs sm:text-sm text-slate-700">Privacy & Data Protection</span>
            </div>
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-4 sm:mb-6">
      ...
      <div className="relative z-10 px-4 sm:px-6 pb-12 sm:pb-20">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/80 backdrop-blur-lg border border-slate-200/60 rounded-2xl p-6 sm:p-8 lg:p-12">
            <div className="space-y-8">
              {sections.map((section, index) => (
                <div key={index} className="border-b border-slate-200/60 last:border-b-0 pb-8 last:pb-0">
            ...
            {/* Summary Box */}
            <div className="mt-12 bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-xl p-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/documentation" 
              className="bg-white/80 hover:bg-white border border-slate-200/60 rounded-lg px-6 py-3 text-center text-slate-800 transition-all"
            >
              View Documentation
            </Link>
            <Link 
