  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Accessing the Database</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Basic Search</h3>
            <p className="text-gray-300 mb-3">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Filter Categories</h3>
            <p className="text-gray-300 mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="bg-white/5 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-white font-semibold">Autoantibody</span>
                </div>
                <p className="text-gray-400 text-sm">Filter by autoantibody name or synonym</p>
              </div>
              <div className="bg-white/5 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <FileText className="w-5 h-5 text-purple-400 mr-2" />
                  <span className="text-white font-semibold">Disease</span>
                </div>
                <p className="text-gray-400 text-sm">Filter by disease name or condition</p>
              </div>
              <div className="bg-white/5 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <Database className="w-5 h-5 text-green-400 mr-2" />
                  <span className="text-white font-semibold">Autoantigen</span>
                </div>
                <p className="text-gray-400 text-sm">Filter by antigen name or target</p>
              </div>
              <div className="bg-white/5 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <BarChart3 className="w-5 h-5 text-yellow-400 mr-2" />
                  <span className="text-white font-semibold">Epitope</span>
                </div>
                <p className="text-gray-400 text-sm">Filter by epitope sequence or structure</p>
              </div>
            </div>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Dependent Filtering</h3>
            <p className="text-gray-300 mb-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Clearing Filters</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">View Modes</h3>
            <p className="text-gray-300 mb-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Result Information</h3>
            <p className="text-gray-300 mb-3">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Core Entities</h3>
            <p className="text-gray-300 mb-3">
              The database organizes information around these core entities:
            </p>
            <div className="space-y-3">
              <div className="bg-white/5 p-4 rounded-lg">
                <h4 className="text-white font-semibold mb-2">Disease</h4>
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Clinical Data</h3>
            <p className="text-gray-300 mb-3">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-white/5 p-4 rounded-lg">
            <h4 className="text-white font-semibold mb-2">Q: Who can access the database?</h4>
          ...
          <div className="bg-white/5 p-4 rounded-lg">
            <h4 className="text-white font-semibold mb-2">Q: How do I search for a specific autoantibody?</h4>
            <p className="text-gray-300 text-sm">
          ...
          <div className="bg-white/5 p-4 rounded-lg">
            <h4 className="text-white font-semibold mb-2">Q: Can I export data from the database?</h4>
            <p className="text-gray-300 text-sm">
          ...
          <div className="bg-white/5 p-4 rounded-lg">
            <h4 className="text-white font-semibold mb-2">Q: How often is the database updated?</h4>
            <p className="text-gray-300 text-sm">
          ...
          <div className="bg-white/5 p-4 rounded-lg">
            <h4 className="text-white font-semibold mb-2">Q: What should I do if I find missing information?</h4>
            <p className="text-gray-300 text-sm">
          ...
          <div className="bg-white/5 p-4 rounded-lg">
            <h4 className="text-white font-semibold mb-2">Q: Is there an API available?</h4>
            <p className="text-gray-300 text-sm">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-3 py-2 sm:px-4 mb-6">
              ...
              <span className="text-xs sm:text-sm text-gray-200">Complete Documentation</span>
            </div>
            ...
            <p className="text-base sm:text-xl text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="space-y-4">
            {sections.map((section) => {
              ...
              return (
                <div key={section.id} className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
                  <button
          ...
          {/* Quick Links */}
          <div className="mt-12 bg-gradient-to-r from-blue-500/20 to-purple-600/20 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6 text-center">Quick Links</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/dashboard/disease/disease" className="bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg p-4 text-center transition-all group">
                <Search className="w-8 h-8 text-blue-400 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-semibold mb-1">Start Searching</h3>
                <p className="text-gray-400 text-sm">Explore the database</p>
              </Link>
              <Link href="/auth/register" className="bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg p-4 text-center transition-all group">
                ...
                <p className="text-gray-400 text-sm">Register for access</p>
              </Link>
              <Link href="/auth/login" className="bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg p-4 text-center transition-all group">
